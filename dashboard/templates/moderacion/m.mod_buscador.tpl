      ...
      <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="usuarios">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><a href="https://extreme-ip-lookup.com/{$u.user_last_ip}" class="geoip" title="Información de IP" target="_blank">{$u.user_last_ip}</a></td>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="muro">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>{$m.p_body}</td>
               <td><a href="https://extreme-ip-lookup.com/{$m.p_ip}" class="geoip" title="Información de IP" target="_blank">{$m.p_ip}</a></td>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="posts">
         ...
         <tbody>
            ...
            <tr id="report_{$r.obj_id}">
               ...
               <td><a href="https://extreme-ip-lookup.com/{$p.post_ip}" class="geoip" title="Información de IP" target="_blank">{$p.post_ip}</a></td>
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="fotos">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><a href="https://extreme-ip-lookup.com/{$f.f_ip}" class="geoip" title="Información de IP" target="_blank">{$f.f_ip}</a></td>
         ...
         <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="p_comentarios">
            ...
            <tbody>
               ...
               <tr id="comentario_{$c.cid}">
                  ...
                  <td><a href="https://extreme-ip-lookup.com/{$c.c_ip}" class="geoip" title="Información de IP" target="_blank">{$c.c_ip}</a></td>
