 ...
 */
    ...
    $config_db = TS_ROOT.'/config.inc.php';
    $install_file = '../instalar/index.php';
    # CON ESTE CÓDIGO SE COMPRUEBA SI EXISTE CONFIG.INC.PHP
    if (file_exists($config_db)) {
        # SI EXISTE Y NO SE INSTALO
        if($db['hostname'] == 'dbhost') header('Location: '.$install_file);
    } else {
