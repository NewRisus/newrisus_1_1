            ...
            case 'likes':
                ...
                if($likes == 1){
                    if($i_like) {
                        ...
                        $data['text'] = '<i class="fas fa-heart"></i>';   
                    }else {
                        ...
                        //
                        $data['text'] = '<i class="fas fa-heart"></i> A <a href="'.$tsCore->settings['url'].'/perfil/'.$u_like['user_name'].'">'.$u_like['user_name'].'</a> le gusta esto.';
                    }
                } elseif($likes == 2){
                    if($i_like){
                        $data['link'] = 'Ya no me gusta';
                        ...
                        //
                        $data['text'] = '<i class="fas fa-heart"></i> A <a href="'.$tsCore->settings['url'].'/perfil/'.$u_like['user_name'].'">'.$u_like['user_name'].'</a> y a ti os gusta esto.';
                    } else {
                        $data['text'] = '<i class="fas fa-heart"></i> A <a onclick="muro.show_likes('.$pub_id.', \'pub\'); return false;">'.$likes.' personas</a> les gusta esto.';
                    }
                } elseif($likes > 2){
                    if($i_like){
                        $data['link'] = 'Ya no me gusta';
                        $data['text'] = '<i class="fas fa-heart"></i> A ti y a <a onclick="muro.show_likes('.$pub_id.', \'pub\'); return false;">otras '.($likes-1).' personas m&aacute;s</a> les gusta esto.';
                    } else {
                        $data['text'] = '<i class="fas fa-heart"></i> A <a onclick="muro.show_likes('.$pub_id.', \'pub\'); return false;">'.$likes.' personas</a> les gusta esto.';
                    }
                }
