...
class tsTops {
	...
	*/
	function getStats(){
        ...
        $return = db_exec('fetch_assoc', db_exec(array(__FILE__, __LINE__), 'query', 'SELECT stats_max_online, stats_max_time, stats_time, stats_time_cache, stats_miembros, stats_posts, stats_comments, stats_foto_comments FROM w_stats WHERE stats_no = \'1\''));
        ...
        $ndat = ', stats_time_cache = \''.time().'\', stats_miembros = \''.$return['stats_miembros'].'\', stats_posts = \''.$return['stats_posts'].'\'';
        }
