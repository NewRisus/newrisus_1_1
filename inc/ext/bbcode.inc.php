...
class BBCode {
    ...
    public function addBBcodes() {
        ...
        $tagCodes = array(
            ...
            array('tag' => 'img', 'replace' => '<img src="{param}" width="80%" alt="Esta imagen puede contener texto"/>', 'parse' => false, 'validParam' => $imgValidator),
            ...
            array('tag' => 'swf', 'replace' => '<embed src="{param}" quality="high" width="100%" height="390px" type="application/x-shockwave-flash" allowfullscreen="true" allownetworking="internal" autoplay="false" wmode="transparent">', 'parse' => false, 'validParam' => $swfValidator),
	...
	public function parseSmiles(){
	   global $tsCore;
		...
		$html = array();
        //
		$pre = '<img src="'.$tsCore->settings['images'].'/smiles/';
        $end = '" align="absmiddle" style="width: auto !important; height; auto !important; display: inline-block !important;"/>';
		// SMILES DEFAULT
        $bbcode[] =":)"; $html[] = $pre."001.png".$end;
        $bbcode[] =":D"; $html[] = $pre."002.png".$end;
        $bbcode[] =":guinio:"; $html[] = $pre."003.gif".$end;
