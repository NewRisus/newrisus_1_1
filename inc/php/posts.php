 ...
 */
    ...
    if(!empty($_GET['post_id'])){
        ...
        if(!empty($category)) {
            ...
            $smarty->assign("Categoria",$catData['c_nombre']);
            $smarty->assign("Descripcion",$catData['c_desc']);
            $smarty->assign("Icono",$catData['c_fa']);
            $smarty->assign("Color",$catData['c_color']);
