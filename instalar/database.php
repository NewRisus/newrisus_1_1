...
CREATE TABLE IF NOT EXISTS `p_categorias` (
  `cid` int(11) NOT NULL AUTO_INCREMENT,
  `c_hcat` INT(11) NOT NULL DEFAULT 0,
...
(1, 0, 1, 'Animaciones', 'animaciones', 'flash.png', 'feather', '212121'),
(2, 0, 2, 'Apuntes y Monografías', 'apuntesymonografias', 'report.png', 'feather', '212121'),
(3, 0, 3, 'Arte', 'arte', 'palette.png', 'feather', '212121'),
(4, 0, 4, 'Autos y Motos', 'autosymotos', 'car.png', 'feather', '212121'),
(5, 0, 5, 'Celulares', 'celulares', 'phone.png', 'feather', '212121'),
(6, 0, 6, 'Ciencia y Educación', 'cienciayeducacion', 'lab.png', 'feather', '212121'),
(7, 0, 7, 'Comics', 'comics', 'comic.png', 'feather', '212121'),
(8, 0, 8, 'Deportes', 'deportes', 'sport.png', 'feather', '212121'),
(9, 0, 9, 'Downloads', 'downloads', 'disk.png', 'feather', '212121'),
(10, 0, 10, 'E-books y Tutoriales', 'ebooksytutoriales', 'ebook.png', 'feather', '212121'),
(11, 0, 11, 'Ecología', 'ecologia', 'nature.png', 'feather', '212121'),
(12, 0, 12, 'Economía y Negocios', 'economiaynegocios', 'economy.png', 'feather', '212121'),
(13, 0, 13, 'Femme', 'femme', 'female.png', 'feather', '212121'),
(14, 0, 14, 'Hazlo tu mismo', 'hazlotumismo', 'escuadra.png', 'feather', '212121'),
(15, 0, 15, 'Humor', 'humor', 'humor.png', 'feather', '212121'),
(16, 0, 16, 'Imágenes', 'imagenes', 'photo.png', 'feather', '212121'),
(17, 0, 17, 'Info', 'info', 'book.png', 'feather', '212121'),
(18, 0, 18, 'Juegos', 'juegos', 'controller.png', 'feather', '212121'),
(19, 0, 19, 'Links', 'links', 'link.png', 'feather', '212121'),
(20, 0, 20, 'Linux', 'linux', 'tux.png', 'feather', '212121'),
(21, 0, 21, 'Mac', 'mac', 'mac.png', 'feather', '212121'),
(22, 0, 22, 'Manga y Anime', 'mangayanime', 'manga.png', 'feather', '212121'),
(23, 0, 23, 'Mascotas', 'mascotas', 'pet.png', 'feather', '212121'),
(24, 0, 24, 'Música', 'musica', 'music.png', 'feather', '212121'),
(25, 0, 25, 'Noticias', 'noticias', 'newspaper.png', 'feather', '212121'),
(26, 0, 26, 'Off Topic', 'offtopic', 'comments.png', 'feather', '212121'),
(27, 0, 27, 'Recetas y Cocina', 'recetasycocina', 'cake.png', 'feather', '212121'),
(28, 0, 28, 'Salud y Bienestar', 'saludybienestar', 'heart.png', 'feather', '212121'),
(29, 0, 29, 'Solidaridad', 'solidaridad', 'salva.png', 'feather', '212121'),
(30, 0, 30, 'Taringa!', 'taringa', 'tscript.png', 'feather', '212121'),
(31, 0, 31, 'Turismo', 'turismo', 'brujula.png', 'feather', '212121'),
(32, 0, 32, 'TV, Peliculas y series', 'tvpeliculasyseries', 'tv.png', 'feather', '212121'),
(33, 0, 33, 'Videos On-line', 'videosonline', 'film.png', 'feather', '212121');";
...
CREATE TABLE IF NOT EXISTS `p_comentarios` (
  ...
  `c_ip` varchar(15) NOT NULL DEFAULT '',
  `mejor_comentario` int(3) NOT NULL DEFAULT 0,
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
...
(1, 1, 30, 'Bienvenido a New Risus', '[align=center][size=18]Este es el primer post de los miles que tendrá tu web  ;)  \r\n\r\nGracias por elegir a [url=http://www.phpost.net]PHPost[/url] como tu Link Sharing System.[/size][/align]', 0, 'NewRisus, Risus, 1.3.0.0, Phpost!', 0, 0, 0, 0, 0, 0, 0);";
...
CREATE TABLE IF NOT EXISTS `u_perfil` (
  ...
  `p_cabecera` varchar(300) NOT NULL DEFAULT '',
  `p_idioma` varchar(10) NOT NULL DEFAULT 'es',
...
CREATE TABLE IF NOT EXISTS `w_configuracion` (
  ...
  `favicon` varchar(100) NOT NULL DEFAULT '0',
  ...
  `codes` int(1) NOT NULL DEFAULT 3,
...
(1, 'New Risus', '/themes/default', 'default', 'Tuente & Miguel92');";
