...
$(document).ready(function(){
   ...
   $('#phpost_directo').click(function(){
   	if(add == 'Si') $('#news_pp').addClass('show'), add = 'No';
   	else $('#news_pp').removeClass('show'), add = 'Si';
   });
   $('#phpost_themes').click(function(){
   	if(add == 'Si') $('#newTheme').addClass('hide').removeClass('show'), add = 'No';
   	else $('#newTheme').removeClass('hide').addClass('show'), add = 'Si';
   });
