...
//			direction:			"ltr",
			...
			smileList: [
				// SMILES DEFAULT
				{title: ":)", img: '<img src="'+global_data.img+'images/smiles/001.png" class="emojiwys">', bbcode:":)"},
				{title: ":D", img: '<img src="'+global_data.img+'images/smiles/002.png" class="emojiwys">', bbcode:":D"},
				{title: ";)", img: '<img src="'+global_data.img+'images/smiles/003.gif" class="emojiwys">', bbcode:";)"},
				{title: ":O", img: '<img src="'+global_data.img+'images/smiles/004.png" class="emojiwys">', bbcode:":O"},
				{title: "(H)", img: '<img src="'+global_data.img+'images/smiles/006.png" class="emojiwys">', bbcode:"(H)"},
				{title: ":P", img: '<img src="'+global_data.img+'images/smiles/104.png" class="emojiwys">', bbcode:":P"},
				{title: "8o|", img: '<img src="'+global_data.img+'images/smiles/049.png" class="emojiwys">', bbcode:"8o|"},
				{title: ":S", img: '<img src="'+global_data.img+'images/smiles/009.png" class="emojiwys">', bbcode:":S"},
				{title: ":$", img: '<img src="'+global_data.img+'images/smiles/008.png" class="emojiwys">', bbcode:":$"},
				{title: ":(", img: '<img src="'+global_data.img+'images/smiles/010.png" class="emojiwys">', bbcode:":("},
				{title: ":'(", img: '<img src="'+global_data.img+'images/smiles/011.gif" class="emojiwys">', bbcode:":'("},
				{title: ":|", img: '<img src="'+global_data.img+'images/smiles/012.png" class="emojiwys">', bbcode:":|"},
				{title: "(6)", img: '<img src="'+global_data.img+'images/smiles/013.png" class="emojiwys">', bbcode:"(6)"},
				{title: "8-|", img: '<img src="'+global_data.img+'images/smiles/050.png" class="emojiwys">', bbcode:"8-|"},
				{title: ":-/", img: '<img src="'+global_data.img+'images/smiles/083.png" class="emojiwys">', bbcode:":-/"},
				{title: "^o)", img: '<img src="'+global_data.img+'images/smiles/051.png" class="emojiwys">', bbcode:"^o)"},
				{title: "(A)", img: '<img src="'+global_data.img+'images/smiles/014.png" class="emojiwys">', bbcode:"(A)"},
				{title: ":[", img: '<img src="'+global_data.img+'images/smiles/043.png" class="emojiwys">', bbcode:":["},
				{title: ":-#", img: '<img src="'+global_data.img+'images/smiles/048.png" class="emojiwys">', bbcode:":-#"},
				{title: ":-*", img: '<img src="'+global_data.img+'images/smiles/052.png" class="emojiwys">', bbcode:":-*"},
				{title: "+o(", img: '<img src="'+global_data.img+'images/smiles/053.png" class="emojiwys">', bbcode:"+o("},
				{title: "(brb)", img: '<img src="'+global_data.img+'images/smiles/066.gif" class="emojiwys">', bbcode:"(brb)"},
				{title: ":^)", img: '<img src="'+global_data.img+'images/smiles/072.gif" class="emojiwys">', bbcode:":^)"},
				{title: "*-)", img: '<img src="'+global_data.img+'images/smiles/073.gif" class="emojiwys">', bbcode:"*-)"},
				{title: "<o)", img: '<img src="'+global_data.img+'images/smiles/075.gif" class="emojiwys">', bbcode:"<o)"},
				{title: "8-)", img: '<img src="'+global_data.img+'images/smiles/076.gif" class="emojiwys">', bbcode:"8-)"},
				{title: "|-)", img: '<img src="'+global_data.img+'images/smiles/078.gif" class="emojiwys">', bbcode:"|-)"},
				{title: ";-/", img: '<img src="'+global_data.img+'images/smiles/082.png" class="emojiwys">', bbcode:";-/"},
				{title: "(jk)", img: '<img src="'+global_data.img+'images/smiles/084.png" class="emojiwys">', bbcode:"(jk)"},
				{title: "(j)", img: '<img src="'+global_data.img+'images/smiles/086.png" class="emojiwys">', bbcode:"(j)"},
				{title: "(V)", img: '<img src="'+global_data.img+'images/smiles/087.png" class="emojiwys">', bbcode:"(v)"},
				{title: "(lol)", img: '<img src="'+global_data.img+'images/smiles/089.gif" class="emojiwys">', bbcode:"(lol)"},
				{title: "(xD)", img: '<img src="'+global_data.img+'images/smiles/090.png" class="emojiwys">', bbcode:"(xd)"},
				{title: ":8)", img: '<img src="'+global_data.img+'images/smiles/088.png" class="emojiwys">', bbcode:":8)"},
				{title: "(ff)", img: '<img src="'+global_data.img+'images/smiles/091.gif" class="emojiwys">', bbcode:"(ff)"},
				{title: "(fm)", img: '<img src="'+global_data.img+'images/smiles/092.gif" class="emojiwys">', bbcode:"(fm)"},
				{title: ":'|", img: '<img src="'+global_data.img+'images/smiles/093.gif" class="emojiwys">', bbcode:":'|"},
				{title: ":]", img: '<img src="'+global_data.img+'images/smiles/094.gif" class="emojiwys">', bbcode:":]"},
				{title: ":}", img: '<img src="'+global_data.img+'images/smiles/095.png" class="emojiwys">', bbcode:":}"},
				{title: "(BOO)", img: '<img src="'+global_data.img+'images/smiles/096.png" class="emojiwys">', bbcode:"(BOO)"},
				{title: "*|", img: '<img src="'+global_data.img+'images/smiles/097.gif" class="emojiwys">', bbcode:"*|"},
				{title: "*\\", img: '<img src="'+global_data.img+'images/smiles/098.png" class="emojiwys">', bbcode:"*\\"},
				{title: "(wm)", img: '<img src="'+global_data.img+'images/smiles/100.png" class="emojiwys">', bbcode:"(wm)"},
				{title: "(xo)", img: '<img src="'+global_data.img+'images/smiles/101.gif" class="emojiwys">', bbcode:"(xo)"},
				{title: "(l)", img: '<img src="'+global_data.img+'images/smiles/015.png" class="emojiwys">', bbcode:"(l)"},
				{title: "(u)", img: '<img src="'+global_data.img+'images/smiles/016.png" class="emojiwys">', bbcode:"(u)"},
				{title: "(@)", img: '<img src="'+global_data.img+'images/smiles/018.png" class="emojiwys">', bbcode:"(@)"},
				{title: "(&)", img: '<img src="'+global_data.img+'images/smiles/019.png" class="emojiwys">', bbcode:"(&)"},
				{title: "(S)", img: '<img src="'+global_data.img+'images/smiles/020.png" class="emojiwys">', bbcode:"(S)"},
				{title: "(*)", img: '<img src="'+global_data.img+'images/smiles/021.png" class="emojiwys">', bbcode:"(*)"},
				{title: "(~)", img: '<img src="'+global_data.img+'images/smiles/022.png" class="emojiwys">', bbcode:"(~)"},
				{title: "(8)", img: '<img src="'+global_data.img+'images/smiles/023.png" class="emojiwys">', bbcode:"(8)"},
				{title: "(E)", img: '<img src="'+global_data.img+'images/smiles/024.png" class="emojiwys">', bbcode:"(E)"},
				{title: "(F)", img: '<img src="'+global_data.img+'images/smiles/025.png" class="emojiwys">', bbcode:"(F)"},
				{title: "(W)", img: '<img src="'+global_data.img+'images/smiles/026.png" class="emojiwys">', bbcode:"(W)"},
				{title: "(O)", img: '<img src="'+global_data.img+'images/smiles/027.gif" class="emojiwys">', bbcode:"(O)"},
				{title: "(K)", img: '<img src="'+global_data.img+'images/smiles/028.png" class="emojiwys">', bbcode:"(K)"},
				{title: "(G)", img: '<img src="'+global_data.img+'images/smiles/029.png" class="emojiwys">', bbcode:"(G)"},
				{title: "(^)", img: '<img src="'+global_data.img+'images/smiles/030.png" class="emojiwys">', bbcode:"(^)"},
				{title: "(P)", img: '<img src="'+global_data.img+'images/smiles/031.png" class="emojiwys">', bbcode:"(P)"},
				{title: "(I)", img: '<img src="'+global_data.img+'images/smiles/032.png" class="emojiwys">', bbcode:"(I)"},
				{title: "(C)", img: '<img src="'+global_data.img+'images/smiles/033.png" class="emojiwys">', bbcode:"(C)"},
				{title: "(T)", img: '<img src="'+global_data.img+'images/smiles/034.png" class="emojiwys">', bbcode:"(T)"},
				{title: "({)", img: '<img src="'+global_data.img+'images/smiles/035.png" class="emojiwys">', bbcode:"({)"},
				{title: "(})", img: '<img src="'+global_data.img+'images/smiles/036.png" class="emojiwys">', bbcode:"(})"},
				{title: "(B)", img: '<img src="'+global_data.img+'images/smiles/037.png" class="emojiwys">', bbcode:"(B)"},
				{title: "(D)", img: '<img src="'+global_data.img+'images/smiles/038.png" class="emojiwys">', bbcode:"(D)"},
				{title: "(Z)", img: '<img src="'+global_data.img+'images/smiles/039.png" class="emojiwys">', bbcode:"(Z)"},
				{title: "(X)", img: '<img src="'+global_data.img+'images/smiles/040.png" class="emojiwys">', bbcode:"(X)"},
				{title: "(Y)", img: '<img src="'+global_data.img+'images/smiles/041.png" class="emojiwys">', bbcode:"(Y)"},
				{title: "(N)", img: '<img src="'+global_data.img+'images/smiles/042.png" class="emojiwys">', bbcode:"(N)"},
				{title: "(nnh)", img: '<img src="'+global_data.img+'images/smiles/044.png" class="emojiwys">', bbcode:"(nnh)"},
				{title: "(#)", img: '<img src="'+global_data.img+'images/smiles/046.png" class="emojiwys">', bbcode:"(#)"},
				{title: "(R)", img: '<img src="'+global_data.img+'images/smiles/047.png" class="emojiwys">', bbcode:"(R)"},
				{title: "(sn)", img: '<img src="'+global_data.img+'images/smiles/054.png" class="emojiwys">', bbcode:"(sn)"},
				{title: "(tu)", img: '<img src="'+global_data.img+'images/smiles/055.png" class="emojiwys">', bbcode:"(tu)"},
				{title: "(pl)", img: '<img src="'+global_data.img+'images/smiles/056.png" class="emojiwys">', bbcode:"(pl)"},
				{title: "(||)", img: '<img src="'+global_data.img+'images/smiles/057.png" class="emojiwys">', bbcode:"(||)"},
				{title: "(pi)", img: '<img src="'+global_data.img+'images/smiles/058.png" class="emojiwys">', bbcode:"(pi)"},
				{title: "(so)", img: '<img src="'+global_data.img+'images/smiles/059.png" class="emojiwys">', bbcode:"(so)"},
				{title: "(au)", img: '<img src="'+global_data.img+'images/smiles/060.png" class="emojiwys">', bbcode:"(au)"},
				{title: "(ap)", img: '<img src="'+global_data.img+'images/smiles/061.png" class="emojiwys">', bbcode:"(ap)"},
				{title: "(um)", img: '<img src="'+global_data.img+'images/smiles/062.png" class="emojiwys">', bbcode:"(um)"},
				{title: "(ip)", img: '<img src="'+global_data.img+'images/smiles/063.png" class="emojiwys">', bbcode:"(ip)"},
				{title: "(co)", img: '<img src="'+global_data.img+'images/smiles/064.png" class="emojiwys">', bbcode:"(co)"},
				{title: "(mp)", img: '<img src="'+global_data.img+'images/smiles/065.png" class="emojiwys">', bbcode:"(mp)"},
				{title: "(st)", img: '<img src="'+global_data.img+'images/smiles/067.png" class="emojiwys">', bbcode:"(st)"},
				{title: "(pu)", img: '<img src="'+global_data.img+'images/smiles/102.png" class="emojiwys">', bbcode:"(pu)"},
				{title: "(yn)", img: '<img src="'+global_data.img+'images/smiles/068.png" class="emojiwys">', bbcode:"(yn)"},
				{title: "(h5)", img: '<img src="'+global_data.img+'images/smiles/069.gif" class="emojiwys">', bbcode:"(h5)"},
				{title: "(mo)", img: '<img src="'+global_data.img+'images/smiles/070.png" class="emojiwys">', bbcode:"(mo)"},
				{title: "(bah)", img: '<img src="'+global_data.img+'images/smiles/071.png" class="emojiwys">', bbcode:"(bah)"},
				{title: "(li)", img: '<img src="'+global_data.img+'images/smiles/074.gif" class="emojiwys">', bbcode:"(lo)"},
				{title: "(wo)", img: '<img src="'+global_data.img+'images/smiles/077.png" class="emojiwys">', bbcode:"(wo)"},
				{title: "'.'", img: '<img src="'+global_data.img+'images/smiles/080.png" class="emojiwys">', bbcode:"'.'"},
				{title: "(bus)", img: '<img src="'+global_data.img+'images/smiles/045.png" class="emojiwys">', bbcode:"(bus)"},
				{title: "*p*", img: '<img src="'+global_data.img+'images/smiles/079.png" class="emojiwys">', bbcode:"*p*"},
				{title: "*s*", img: '<img src="'+global_data.img+'images/smiles/085.png" class="emojiwys">', bbcode:"*s*"},
				{title: "(M)", img: '<img src="'+global_data.img+'images/smiles/017.png" class="emojiwys">', bbcode:"(M)"},
				{title: "(xx)", img: '<img src="'+global_data.img+'images/smiles/103.png" class="emojiwys">', bbcode:"(xx)"},
				/* {title: ":CODIGO:", img: '<img src="'+global_data.img+'images/smiles/.gif">', bbcode:":CODIGO:"}, */
			],
		...
		imgLoadModal: function() {
			...
			if (this.options.imgupload===true) {
				...
				this.$modal.find("#fupform").on("submit",$.proxy(function(e) {
					$(e.target).parents("#imguploader").hide().after('<div class="loader"><img src="'+global_data.img+'images/wysibb/loader.gif" /><br/><br/><span>'+CURLANG.loading+'</span></div>').parent().css("text-align","center");
				},this))
