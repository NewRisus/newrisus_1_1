...
var muro = {
   ...
   load_atta: function(type, ID, obj) {
      switch (type) {
         case 'foto':
            var content = '<img src="' + ID + '" style="width:100%;" />';
         break;
         case 'video':
            var content = '';
            content += '<iframe width="100%" height="315"  '
            content += 'src="https://www.youtube.com/embed/' + ID + '" '
            content += 'allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" '
            content += 'allowfullscreen frameborder="0">'
            content += '</iframe>'
         break;
      }
      // CARGAMOS
