...
<html lang="es">
    <head>
        ...
        <link href="{$tsConfig.tema.t_url}/source/webfonts/all.min.css?{$smarty.now}" rel="stylesheet" type="text/css" />
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-Z2PCT6X4T9"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-Z2PCT6X4T9');
      </script>
        <script data-ad-client="ca-pub-0602815864868883" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        <script>
          (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "ca-pub-1660418710918187",
    ...
    <body>
       ...
       <!--JAVASCRIPT-->
       <div class="progress" id="loading" style="display:none; height:5px;">
