   ...
   <div class="widget clearfix" id="perfil-news">
      ...
      <div id="news-content">
         ...
         <div class="Story" id="pub_{$p.pub_id}">
            <a href="{$tsConfig.url}/perfil/{$p.user_name}" class="Story_Pic"><img alt="{$p.user_name}" src="{$tsConfig.url}/files/avatar/{$p.p_user_pub}_120.jpg"/></a>
                        ...
                        <ul id="cl_{$p.pub_id}" class="commentList">
                           ...
                           <li class="ufiItem">
                              <div class="more_comments clearfix">
                                 ...
                                 <img width="16" height="11" src="{$tsConfig.images}/loader.gif"/>
                              </div>
                           </li>
                           {/if}
