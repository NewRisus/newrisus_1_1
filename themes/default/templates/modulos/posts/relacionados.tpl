<div class="nr-home-box">
    ...
    <ul>
        <li class="nr-home-comments">
            <a href="{$tsConfig.url}/posts/{$p.c_seo}/" style="background: #{$p.c_color}; color: #fff; border-radius: 3px; width: 15px;font-size: .8em;text-align: center;"><i class="fas fa-{$p.c_fa}"></i></a>
